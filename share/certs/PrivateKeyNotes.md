...
unlocked to sign the gecicoin-Qt.app bundle.
...
allowing somebody to distribute a gecicoin-Qt.app or gecicoin-qt-setup.exe with a valid
...
that the gecicoin-qt.exe file inside the installer had not been tampered with.
