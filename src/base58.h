...
//
#ifndef GECCOIN_BASE58_H
#define GECCOIN_BASE58_H
 ...
 * Public-key-hash-addresses have version 125 (or 127 testnet).
...
public:
    enum
    {
        PUBKEY_ADDRESS = 25, // address begins with B
        SCRIPT_ADDRESS = 5,
